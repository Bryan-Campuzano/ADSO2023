...
if ($query->rowCount() > 0) {
    ...
    if ($userData['Rol'] == 6) {
        ...
        echo "<script>window.location.replace('../front/dashboard.php');</script>";
    } else {
        echo "<script> alert('No tienes permisos para acceder a la dashboard'); "
        . "window.location.replace('../front/home.php');</script>";
    }
} else {
